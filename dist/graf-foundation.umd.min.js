...
t.style.visibility="hidden",t.style.width="1px",t.style.height="1px",t.onload=function(){setTimeout(function(){document.body.removeChild(t)},0)},document.body.appendChild(t)},0)},createObjectURL:function(t){return(window.URL||window.webkitURL).createObjectURL(t)}};var f={toJSONString:function(t){return JSON.stringify(t)},parseObject:function(t){return JSON.parse(t)}};var d={isPhone:function(t){return/^1[3-9]\d{9}$/.test(t)},isIdCard:function(t){return/(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{2}$)|(^\d{15}$)/.test(t)},isHan:function(t){return/^[\u4e00-\u9fa5]{0,}$/.test(t)},isAge:function(t){if(!/^[0-9]+$/.test(t))return!1;var e=parseInt(t);return!(e<0||150<e)},isEnOrNumber:function(t){return/^[A-Za-z0-9]+$/.test(t)},isEmoji:function(t){
/* eslint-disable yoda */
for(var e=0;e<t.length;e++){var r=t.charCodeAt(e);if(55296<=r&&r<=56319){if(1<t.length){var n=1024*(r-55296)+(t.charCodeAt(e+1)-56320)+65536;if(118784<=n&&n<=128895)return!0}}else if(1<t.length){if(8419===t.charCodeAt(e+1))return!0}else{if(8448<=r&&r<=10239)return!0;if(11013<=r&&r<=11015)return!0;if(10548<=r&&r<=10549)return!0;if(12951<=r&&r<=12953)return!0;if(169===r||174===r||12349===r||12336===r||11093===r||11036===r||11035===r||11088===r)return!0}}}};var l={isObject:function(t){return t&&"[object Object]"==={}.toString.call(t)},isNullOrEmpty:function(t){if(null==t)return!0;for(var e in t)if(t.hasOwnProperty(e))return!1;return!0},deepCopy:function(t){if(null===t)return t;if("object"!==(void 0===t?"undefined":o(t)))return t;var e="[object Array]"==={}.toString.call(t)?[]:{};for(var r in t)t.hasOwnProperty(r)&&(e[r]="object"===o(t[r])?this.deepCopy(t[r]):t[r]);return e}};var m={get:function(t){return r.get(t)},set:function(t,e){return r.set(t,e)},remove:function(t){return r.remove(t)},clearAll:function(){return r.clearAll()}};
/* eslint-disable */function g(){for(var t=0,e={};t<arguments.length;t++){var r=arguments[t];for(var n in r)e[n]=r[n]}return e}var _=function t(l){function m(t,e,r){var n;if("undefined"!=typeof document){
// Write
...
/*
   ...
   */
rstr2hex:function(t){for(var e,r=p?"0123456789ABCDEF":"0123456789abcdef",n="",i=0;i<t.length;i++)e=t.charCodeAt(i),n+=r.charAt(e>>>4&15)+r.charAt(15&e);return n},
/*
   * Convert a raw string to a base-64 string
   */
rstr2b64:function(t){for(var e="",r=t.length,n=0;n<r;n+=3)for(var i=t.charCodeAt(n)<<16|(n+1<r?t.charCodeAt(n+1)<<8:0)|(n+2<r?t.charCodeAt(n+2):0),o=0;o<4;o++)8*n+6*o>8*t.length?e+=y:e+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(i>>>6*(3-o)&63);return e},
/*
 ...
 */
var C=require("js-base64").Base64;t.StringUtils=e,t.ArrayUtils=n,t.DateUtils=c,t.GeneralUtils=h,t.JsonUtils=f,t.MatcherUtils=d,t.ObjectUtils=l,t.StorageUtils=m,t.Cookie=_,t.Md5=v,t.Base64=C,t.RCModel=b,t.Check=
/**
 * 检验model的属性
 * @param type - 参数类型
 * @returns {Function}
