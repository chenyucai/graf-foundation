...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('store')) :
	typeof define === 'function' && define.amd ? define(['exports', 'store'], factory) :
	(factory((global.GrafFoundation = global.GrafFoundation || {}),global.store));
...
function isIdCard(str) {
  var pattern = /(^[1-9]\d{5}(18|19|([23]\d))\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{3}[0-9Xx]$)|(^[1-9]\d{5}\d{2}((0[1-9])|(10|11|12))(([0-2][1-9])|10|20|30|31)\d{2}$)|(^\d{15}$)/;
  return pattern.test(str);
}
